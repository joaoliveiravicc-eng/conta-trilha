...
{id:"ent1", title:"Lendo a vaga como o recrutador", icon:"🔎",
 ...
 ex:[
  ...
  mc("A vaga fala em “correto direcionamento dos documentos conforme os processos internos”. Na prática, isso é:",["*Enviar cada nota à empresa, ao centro de custo e ao aprovador certos","Devolver ao fornecedor toda nota que chega com qualquer diferença","Arquivar as notas em ordem alfabética, sem encaminhar a ninguém","Pagar a nota no mesmo dia em que ela chega, para evitar atrasos"],"Direcionar é fazer o documento seguir o caminho certo: empresa do grupo, centro de custo e aprovação."),
  ...
  mc("Quem trabalha com notas e compras, mas usa só o básico do Excel, deve priorizar o que até a entrevista?",["*PROCV, SOMASES e tabela dinâmica, que a vaga cita","Programação em VBA e criação de macros complexas","A história da empresa, em vez das funções da vaga","A legislação do ICMS de todos os estados do país"],"Excel avançado é requisito indispensável e costuma cair em teste prático."),
...
{id:"ent2", title:"O Grupo Massa", icon:"🏢",
 ...
 ex:[
  ...
  mc("Numa entrevista no Grupo Massa, qual resposta mostra que você pesquisou a empresa?",["*“O grupo tem TV, rádios, portal e agro. Deve ter muitas notas e contratos diferentes.”","“É a empresa do Ratinho, que eu assisto desde criança e admiro muito, e por isso quero trabalhar aqui.”","“Não pesquisei a fundo, mas aprendo rápido e me adapto a qualquer lugar.”","“Sempre quis trabalhar em televisão, então qualquer vaga aqui me serve.”"],"Relacionar o negócio da empresa ao dia a dia do cargo mostra preparo."),
...
{id:"ent3", title:"CLT, jornada e benefícios", icon:"📄",
 ...
 ex:[
  ...
  mc("O recrutador pergunta sua pretensão salarial. A resposta mais profissional é:",["*Uma faixa de salário bruto, com base em pesquisa e nos benefícios","Devolver a pergunta e pedir que a empresa diga quanto paga","Dizer que qualquer valor serve, para não perder a chance","Falar só o valor líquido que você quer receber no mês"],"Faixa pesquisada, em bruto, mostra preparo e deixa espaço para negociar.")
 ]},
...
{id:"ent4", title:"Fale sobre você", icon:"🙋",
 ...
 ex:[
  ...
  mc("Qual é o melhor começo para “fale sobre você”?",["*“Hoje faço lançamento e conferência de notas, compras e contas a pagar.”","“Nasci em Curitiba, tenho dois irmãos e sempre gostei muito de estudar.”","“Está tudo no meu currículo, que o senhor já deve ter lido com atenção.”","“Estou precisando muito desta vaga, porque as contas do mês estão apertadas.”"],"Comece pelo que você faz e que conversa com a vaga."),
  ...
  mc("“Vi que você está empregado. Por que quer sair?” A melhor resposta:",["*Falar do que busca, como orçamento e indicadores, sem criticar a empresa atual","“Meu chefe é muito difícil e não valoriza o meu trabalho, então quero sair de lá.”","“Lá eu não aprendo mais nada, e a rotina ficou repetitiva e cansativa.”","“Saio principalmente pelo salário, que aqui pode ser bem melhor que lá.”"],"Fale do que você quer construir, não do que quer deixar para trás."),
...
{id:"ent5", title:"Histórias no método STAR", icon:"⭐",
 ...
 ex:[
  ...
  mc("Numa entrevista: “Nós organizamos o processo e deu tudo certo.” O que falta nessa resposta?",["*O que você fez e qual foi o resultado concreto","Mais adjetivos, para a resposta soar mais confiante","O nome completo da empresa onde isso aconteceu","A data exata de cada etapa que foi realizada"],"Troque o “nós” pelo que você fez e mostre o resultado, se der, com número."),
  ...
  mc("Qual história mostra melhor a sua iniciativa?",["*Você criou uma planilha que avisa as notas perto do vencimento","Você sempre chega no horário e nunca falta ao trabalho","Você fez tudo o que o seu chefe mandou, exatamente do jeito que ele pediu","Você é muito querido pela equipe e ajuda quem precisa"],"Iniciativa é melhorar algo sem ninguém pedir."),
...
{id:"ent6", title:"Pontos fortes, fracos e motivação", icon:"💪",
 ...
 ex:[
  mc("Numa entrevista para analista, qual é a melhor resposta sobre ponto forte?",["*“Atenção a detalhes: confiro nota, pedido e recebimento antes de lançar.”","“Sou perfeito em tudo o que faço e nunca cometo erros no trabalho.”","“Sou muito esforçado e dedicado, e nunca reclamo de nenhuma tarefa que recebo.”","“Sou muito ativo nas redes sociais e tenho muitos contatos na área.”"],"Qualidade ligada à vaga e provada com um fato."),
  mc("Numa entrevista, qual é a melhor resposta sobre ponto a melhorar?",["*Algo real, fora do centro da vaga, e o que você faz para melhorar","“Sou perfeccionista demais e trabalho até tarde para deixar tudo perfeito.”","“Não tenho pontos fracos; sempre entrego tudo dentro do prazo.”","“Sou desorganizado com prazos e esqueço tarefas importantes com frequência.”"],"Honestidade com plano de melhoria. Desorganização com prazos derrubaria você nesta vaga."),
  ...
  mc("“Onde você se vê em 5 anos?” A melhor resposta:",["*Com mais experiência, assumindo análises maiores, como orçamento e controladoria","“No seu lugar, dirigindo a empresa, porque tenho muita ambição e quero crescer rápido.”","“Não faço a menor ideia, porque prefiro viver um dia de cada vez.”","“Com um negócio próprio, fora da área financeira e longe da empresa.”"],"Ambição compatível com a empresa e com a área."),
...
{id:"ent7", title:"Notas fiscais na entrevista", icon:"🧾",
 ...
 ex:[
  ...
  mc("A nota veio com quantidade maior do que a recebida. O que fazer?",["*Não lançar e pedir nova nota: carta de correção não muda quantidade","Emitir uma carta de correção com a quantidade certa e lançar a nota","Lançar a nota como veio e ajustar a diferença só no mês seguinte","Pagar a quantidade que consta na nota e negociar depois"],"Quantidade mexe no valor e no imposto. A CC-e não pode corrigir isso."),
...
{id:"ent8", title:"Compras e ordens de compra", icon:"🛒",
 ...
 ex:[
  ...
  mc("Um gestor pede para pagar uma nota de serviço que não tem ordem de compra. O que fazer?",["*Explicar o processo e pedir a regularização com aprovação antes de pagar","Pagar a nota, já que o gestor pediu e é ele quem manda na área","Recusar o pedido sem dar explicação e encerrar a conversa","Criar a OC com uma data antiga, sem aprovação, para justificar o pagamento"],"O processo protege a empresa e o próprio gestor."),
...
{id:"ent9", title:"Contratos sob controle", icon:"📑",
 ...
 ex:[
  ...
  mc("A empresa de limpeza mandou a fatura 8% maior, dizendo que é reajuste. O que conferir?",["*Se o contrato prevê reajuste, o índice e a data-base, e se 8% bate","Nada, porque todo reajuste é automático e não precisa de conferência","Só se o e-mail com a cobrança veio mesmo do fornecedor certo","Se a limpeza foi bem feita no mês em que o reajuste começou"],"O reajuste segue o que está no contrato."),
...
{id:"ent10", title:"Previsto x realizado", icon:"📊",
 ...
 ex:[
  ...
  mc("Numa despesa, realizado abaixo do previsto é:",["*Favorável, mas vale ver se foi economia ou só atraso","Sempre desfavorável, pois indica que faltou execução do orçamento","Sinal de erro no orçamento, que deve ser refeito do zero","Irrelevante, porque o que importa é só o total do ano"],"Um gasto que só atrasou vai aparecer no mês seguinte."),
  mc("Numa receita, realizado abaixo do previsto é:",["*Desfavorável, pois entrou menos do que o previsto","Favorável, pois sobrou espaço para gastar mais no mês","Neutro, pois a receita não entra na análise"],"Entrou menos do que o planejado."),
...
{id:"ent11", title:"Relatórios e indicadores", icon:"📈",
 ...
 ex:[
  ...
  mc("Dois relatórios do mesmo mês mostram totais diferentes. A causa mais provável é:",["*Datas de corte ou bases de dados diferentes","Erro do próprio Excel, que soma diferente a cada abertura","Um dos relatórios usa um tipo de gráfico diferente","A fonte da letra escolhida em cada um dos relatórios"],"Por isso se define uma base única e uma data de corte."),
...
{id:"ent12", title:"Noção fiscal e contábil", icon:"🧮",
 ...
 ex:[
  ...
  mc("Na retenção de tributos de uma nota de serviço, quem recolhe o valor retido ao governo?",["*A empresa que paga o serviço, em nome de quem prestou","O fornecedor, depois de receber o valor líquido da nota","O banco, automaticamente, na hora em que o pagamento sai","Ninguém: o valor retido fica com a própria empresa que paga"],"O tomador desconta e recolhe. Por isso ele responde pelo recolhimento."),
...
{id:"ent13", title:"Perguntas para o entrevistador", icon:"❓",
 ...
 ex:[
  ...
  mc("O entrevistador pergunta: “Você tem alguma pergunta?” A melhor atitude:",["*Fazer uma ou duas perguntas preparadas sobre a rotina","Dizer “não, está tudo claro” para encerrar logo a conversa","Perguntar logo de início qual é o salário e os benefícios","Perguntar o que a empresa faz, já que não pesquisou antes"],"Mostra interesse e preparo."),
  ...
  mc("Qual pergunta ao entrevistador ajuda a entender a rotina real do cargo?",["*“Como é o fechamento do mês e quais dias são mais puxados?”","“Tem estacionamento no prédio e vaga para quem vai de carro?”","“Posso trabalhar de casa alguns dias por semana, se precisar?”","“Quando são as férias coletivas e como funcionam os feriados?”"],"A rotina de fechamento diz muito sobre o dia a dia da função."),
...
{id:"ent14", title:"O dia da entrevista", icon:"📅",
 ...
 ex:[
  ...
  mc("Na entrevista, perguntam sobre uma regra de imposto que você não conhece. Como agir?",["*Dizer o que sabe, admitir o que não sabe e dizer onde buscaria","Mudar de assunto e tentar voltar a falar do que domina","Dizer que esse assunto não é importante para a vaga","Responder qualquer coisa, mas com muita segurança na voz e no olhar"],"Honestidade e saber pesquisar valem mais do que decorar tudo."),
...
{id:"ent15", title:"Simulado final da entrevista", icon:"🏁",
 ...
 ex:[
  ...
  mc("A nota chegou com preço unitário diferente da ordem de compra. O que fazer?",["*Segurar o lançamento, confirmar o preço com compras e pedir nova nota","Lançar pelo preço da nota e acertar a diferença no próximo pagamento do mês","Mandar uma carta de correção com o preço certo e lançar a nota","Pagar a nota e descontar a diferença na próxima compra"],"Preço mexe no valor: não cabe carta de correção."),
  ...
  mc("Você percebe que lançou uma nota no centro de custo errado no mês passado. O que fazer?",["*Avisar o responsável e corrigir com uma reclassificação","Deixar como está, porque o mês passado já foi fechado","Apagar o lançamento antigo e refazer no centro certo, sem avisar","Esperar que alguém perceba o erro e peça a correção"],"Corrigir com transparência é integridade na prática."),
