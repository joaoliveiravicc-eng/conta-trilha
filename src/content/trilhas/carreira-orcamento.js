...
{id:"orc1", title:"Do plano ao número", icon:"🗓️",
 ...
 ex:[
  ...
  mc("Qual premissa mais afeta o orçamento de salários?",["*O reajuste salarial da categoria e o número de pessoas previsto","O prazo médio de recebimento","O saldo bancário do mês","A quantidade de notas lançadas"],"Folha = pessoas × salários. Reajuste e contratações mudam o total."),
  ...
  mc("Qual o principal risco de orçar só pela base histórica?",["*Repetir gastos desnecessários do ano anterior","Não conseguir calcular","Ignorar sempre a inflação","Ficar sem centros de custo"],"Se o ano anterior tinha desperdício, ele passa para o novo orçamento.")
 ]},
{id:"orc2", title:"Centros de custo e contas", icon:"🏷️",
 ...
 ex:[
  ...
  mc("Uma nota de R$ 8.000 do Comercial foi lançada no centro Administrativo. O que acontece no relatório?",["*O Administrativo parece gastar R$ 8.000 a mais e o Comercial, R$ 8.000 a menos","Nada: o total da empresa é o mesmo","Os dois centros ficam R$ 8.000 acima","A nota some do relatório"],"O total não muda, mas a análise por área fica errada."),
  ...
  mc("O diesel do gerador que abastece o prédio inteiro deve ir para:",["*Um centro comum ou ser rateado entre as áreas, pelo critério da empresa","Sempre o Jornalismo","Nenhum centro","O centro de quem pagou o boleto"],"Gasto que serve a todos é rateado ou fica num centro comum.")
 ]},
{id:"orc3", title:"Previsto, comprometido e realizado", icon:"🔒",
 ...
 ex:[
  ...
  mc("Previsto de R$ 50.000, realizado de R$ 38.000 e comprometido de R$ 9.000. Uma compra de R$ 5.000 cabe?",["*Não: sobram R$ 3.000; é preciso remanejar verba ou aprovar o estouro","Sim: sobram R$ 12.000","Sim: sobram R$ 5.000","Não dá para saber"],"50.000 − 38.000 − 9.000 = 3.000 disponíveis."),
  ...
  mc("A área cancelou uma OC de R$ 4.000 que não será usada. O que acontece com o orçamento?",["*O comprometido cai R$ 4.000, e esse valor volta a ficar disponível","O realizado aumenta R$ 4.000","Nada muda","O previsto cai R$ 4.000"],"Cancelar libera a verba que estava reservada."),
  ...
  mc("Um gestor com alçada de até R$ 10.000 pede duas OCs de R$ 9.000 para a mesma compra. O que fazer?",["*Não dividir: a compra é de R$ 18.000 e precisa da aprovação da alçada correspondente","Emitir as duas OCs","Emitir uma de R$ 10.000 e outra de R$ 8.000","Pagar sem OC"],"Isso é fracionamento, e as auditorias procuram exatamente esse padrão.")
 ]},
{id:"orc4", title:"Mês a mês: sazonalidade", icon:"📅",
 ...
 ex:[
  ...
  mc("Março mostra +40% em manutenção, mas o acumulado do ano está +5%. A leitura mais provável:",["*O gasto se concentrou em março, sem estouro relevante no ano","A área perdeu o controle","O orçamento está errado","A nota foi lançada em duplicidade, com certeza"],"Diferença de calendário: o mês engana, o acumulado mostra a tendência."),
...
{id:"orc5", title:"O sinal da variação", icon:"➕",
 ...
 ex:[
  ...
  mc("Qual pergunta resolve a dúvida entre favorável e desfavorável?",["*Isso melhora ou piora o resultado da empresa?","O número é positivo ou negativo?","A conta começa com 3 ou com 4?","O gestor gostou?"],"O sinal da conta confunde; o efeito no resultado, não."),
...
{id:"orc6", title:"Acumulado e forecast", icon:"🔭",
 ...
 ex:[
  ...
  mc("Qual forecast é mais confiável?",["*O que parte do realizado e ajusta os meses restantes com fatos conhecidos, como reajustes e compras aprovadas","Repetir o orçamento original sem mudanças","Multiplicar o mês mais caro por 12","Um valor redondo estimado de cabeça"],"Realizado + fatos conhecidos: é o que dá para defender."),
  ...
  mc("Em abril, o forecast indica estouro de R$ 10.000 no ano. Qual a melhor atitude?",["*Avisar o gestor já, com opções: adiar gastos, renegociar ou remanejar verba","Esperar dezembro para ver se confirma","Lançar parte das notas no ano seguinte","Não falar nada, porque pode melhorar"],"Quanto antes o aviso, mais opções o gestor tem."),
...
{id:"orc7", title:"Preço ou volume?", icon:"⚖️",
 ...
 ex:[
  ...
  mc("A empresa consumiu menos energia, mas a conta subiu. O que explica?",["*A tarifa subiu mais do que a economia no consumo","O consumo aumentou","A conta está errada, com certeza","O efeito volume foi positivo"],"Efeito volume favorável, efeito preço desfavorável e maior."),
...
{id:"orc9", title:"Indicadores de contas a pagar", icon:"🧾",
 ...
 ex:[
  ...
  mc("Em março, a empresa pagou R$ 1.200 de multas e juros por atraso. Isso é:",["*Um custo evitável, que vale acompanhar como indicador","Um investimento","Uma receita financeira","Normal e sem importância"],"Atraso custa dinheiro e desgasta a relação com o fornecedor."),
  mc("Para que serve o aging de contas a pagar?",["*Programar o caixa e achar títulos parados ou vencidos","Calcular a depreciação","Medir a receita do mês","Substituir a conciliação bancária"],"Mostra o que vence quando e o que está atrasado."),
...
{id:"orc10", title:"Indicadores de compras e notas", icon:"🛒",
 ...
 ex:[
  ...
  mc("O saving foi calculado sobre uma cotação inicial muito acima do mercado. O problema é que:",["*O saving parece maior do que a economia real","O saving fica negativo","Não há problema","A compra fica mais cara"],"A base de comparação precisa ser honesta."),
...
{id:"orc11", title:"O relatório mensal", icon:"📰",
 ...
 ex:[
  mc("Qual comentário é o melhor para o gestor?",["*“Manutenção +R$ 6.000: conserto urgente do gerador, não recorrente.”","“Gasto maior que o previsto.”","“Verificar.”","“Manutenção estourou.”"],"Valor, causa e se vai se repetir."),
...
{id:"orc12", title:"Rede Capivara: o fechamento de março", icon:"📺",
 ...
 ex:[
  ...
  mc("A Programação ficou R$ 7.200 abaixo porque a estreia de um programa foi adiada para maio. Como comentar?",["*Não é economia: o gasto foi adiado para maio e entra no forecast","Economia de R$ 7.200 no ano","A área cortou custos","Erro de lançamento"],"Gasto adiado não é gasto evitado.")
 ]},
{id:"orc13", title:"Rede Capivara: forecast e plano de ação", icon:"🧭",
 ...
 ex:[
  ...
  mc("A Programação está R$ 7.200 abaixo porque uma estreia foi adiada para maio. Usar essa “sobra” para cobrir o estouro do Jornalismo é:",["*Arriscado: o gasto da Programação vai acontecer em maio, então a sobra não é real","Uma boa solução","Obrigatório","Indiferente"],"Gasto adiado não libera verba de verdade."),
  mc("Qual é o melhor encaminhamento para o estouro previsto do Jornalismo?",["*Avisar já o gestor com o forecast e opções com valores: renegociar diárias e combustível, rever a escala ou pedir suplementação","Esperar o fim do ano","Lançar parte dos gastos em outros centros","Cortar a cobertura sem falar com ninguém"],"Número, causa e opções. A decisão é do gestor."),
