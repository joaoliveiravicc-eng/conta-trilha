...
export const LAYOUT = [
 ...
 {id:"car_orcamento", panel:"car_ferr", open:true, title:"Orçamento e indicadores", icon:"💰", color:"#B7791F", desc:"Previsto, comprometido e realizado, forecast, preço x volume, ajustes do fechamento, indicadores de pagar e de compras, e o relatório que o gestor lê.",
  units:[["Como o orçamento funciona",["orc1","orc2","orc3","orc4"]],["Analisando variações",["orc5","orc6","orc7","orc8"]],["Indicadores e relatório",["orc9","orc10","orc11"]],["Na prática: a Rede Capivara",["orc12","orc13"]]]},
 {id:"car_rotina", panel:"car_vaga", open:true, title:"Notas, compras e contratos", icon:"🧾", color:"#2F6F8F", desc:"A nota por dentro, manifestação, carta de correção, cancelamento e devolução, retenções na prática, CBS e IBS em 2026, cotação, recebimento e contratos.",
  units:[["Notas fiscais por dentro",["rot1","rot2","rot3","rot4"]],["Quando a nota vem errada",["rot5","rot6","rot7"]],["Retenções e Reforma Tributária",["rot8","rot9","rot10","rot11"]],["Compras e contratos a fundo",["rot12","rot13","rot14"]],["Na prática",["rot15","rot16"]]]},
