...
const built = buildCourses(
  ...
  antes.concat(vida, estoq, digital, financeiroJr, deepenFund, deepenOp, deepenGestao, practiceThemes, SCENARIO_LESSONS, careerExcel, careerInterview, careerBudget),
  extra, layouts
);
