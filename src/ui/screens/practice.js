...
import { trainingHub, hubTrain } from './training.js';
...
export function renderPractice(){
  ...
  s.innerHTML = '<div class="pad"><h1 style="font-size:1.45rem">Praticar</h1><p class="muted small" style="margin:4px 0 16px">Repetir é o que transforma teoria em habilidade.</p>' +
    ...
    trainingHub(activeCourses) + '<h2 class="sec-h" style="margin:22px 0 8px">Casos práticos</h2><div id="case-list"></div>' +
  ...
  bindActs(s, {
    ...
    blitz: openBlitz,
    hubtrain: b => hubTrain(b, activeCourses)
  });
}
